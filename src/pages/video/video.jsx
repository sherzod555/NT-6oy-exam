    ...
    <div className="container mx-auto px-[75px] pb-12">
        <div className="w-[70%] pt-[110px]">
          ...
          <div className="pt-3 flex justify-between items-center">
           <p className="text-[#C2C2C2] text-sm">{formatViewCount(videoData?.items[0].statistics.viewCount)} views</p>
           <div className="flex items-center gap-x-[10px]">
            <div className="flex gap-x-2 items-center px-5 py-[8px] rounded-[20px] bg-[#EBEBEB] hover:bg-[#d5d5d5]">
              ...
              <p>{formatViewCount(videoData?.items[0].statistics.likeCount)} Likes</p>
            </div>
            <div className="flex gap-x-2 items-center px-5 py-[8px] rounded-[20px] bg-[#EBEBEB] hover:bg-[#d5d5d5]">
          ...
          <div>
            <div className="pt-10">
            <img
            className="w-20 h-20 rounded-full" src={videoData?.items[0].snippet.thumbnails.default.url} alt="channel img" />
            <div>
              <h2>{videoData?.items[0].snippet.channelTitle}</h2>
              <p>Published on {formatDate(videoData?.items[0].snippet.publishedAt)}</p>
              <p>
